...
class ModifiedMacosSearchField<T> extends StatefulWidget {
  ...
  const ModifiedMacosSearchField({
    super.key,
    this.results,
  ...
  /// Specifies the `TextEditingController` for [ModifiedMacosSearchField].
  ...
  /// Use this to get the current search query of the [ModifiedMacosSearchField].
  ///
  ...
  @override
  State<ModifiedMacosSearchField<T>> createState() =>
      _ModifiedMacosSearchFieldState();
}

class _ModifiedMacosSearchFieldState<T>
    extends State<ModifiedMacosSearchField<T>> {
